...
namespace Game.Sound.Impl
{
    ...
    {
        public SoundRepository Repository;
        public GlobalSoundSettings GlobalSoundSettings;
        
        private ISoundRepository _soundRepository;
        private IGlobalSoundSettings _globalSoundSettings;
        private IAudioSourceProvider _audioSourceProvider;
        ...
        public void Init()
        {
            if (_inited )
                return;
            _inited = true;
            _audioSourceProvider = GetComponent<IAudioSourceProvider>();
            _soundRepository = Repository;
            _globalSoundSettings = GlobalSoundSettings;
